...
namespace AlumnoEjemplos.RestrictedGL.Utils
{
    ...
    /// 
    /// </summary>
    public class MeshShader : TgcMesh
    {
        public Effect effect;

        public MeshShader(Mesh mesh, string name, MeshRenderType renderType)
            : base(mesh, name, renderType) {
        }

        public MeshShader(string name, TgcMesh parentInstance, Vector3 translation, Vector3 rotation, Vector3 scale)
        ...
        public new MeshShader createMeshInstance(string name) {
    ...
    /// </summary>
    public class MeshShaderFactory : TgcSceneLoader.IMeshFactory
    {
        public TgcMesh createNewMesh(Mesh d3dMesh, string meshName, TgcMesh.MeshRenderType renderType) {
            return new MeshShader(d3dMesh, meshName, renderType);
        }
        ...
        public TgcMesh createNewMeshInstance(string meshName, TgcMesh originalMesh, Vector3 translation, Vector3 rotation, Vector3 scale) {
            return new MeshShader(meshName, originalMesh, translation, rotation, scale);
        }
    }
}